 ...
 * @author ZhaoZaigang
 * @Description  Http配置
 * @date 2017/10/25  17:10
 */

public class Http {
    private static OkHttpClient client;
    private static WorkApiService httpService;
     ...
     */
    public static WorkApiService getWorkService() {
        if (httpService == null) {
            httpService = getRetrofit().create(WorkApiService.class);
        }
        return httpService;
    }
        ...
        Interceptor headerInterceptor = new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                Request.Builder requestBuilder = originalRequest.newBuilder()
                        ...
                        .header("token", (String) SPUtil.get(App.getInstance(),"config","token", ""))
            ...
            synchronized (Http.class) {
                if (retrofit == null) {
                    ...
                    retrofit = new Retrofit
                            .Builder()
                            .baseUrl(BuildConfig.API_HOST) // 自己配置
                            .client(client)
